 ...
 * Copyright (C) 2010, 2011, 2012, 2013, 2016, 2019, 2020, 2021, 2022, 2023  AO Industries, Inc.
...
public class AuthorizeNetTestTODO extends TestCase {
  ...
  private static synchronized String getConfig(String name) throws IOException {
    if (config == null) {
      config = PropertiesUtils.loadFromResource(AuthorizeNetTestTODO.class, "AuthorizeNetTest.properties");
    }
